return {
	...
	config = function()
		...
		keymap.set("n", "<leader>gtw", "<cmd>Gitsigns toggle_word_diff<CR>", { desc = "Word differenes" })
		keymap.set("n", "<leader>gtb", "<cmd>Gitsigns toggle_current_line_blame<CR>", { desc = "Line blame" })
